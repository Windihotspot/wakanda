<template>
    <MainLayout>
      ...
      <v-card class="rounded-lg pa-6" color="primary" dark>
        <div class="d-flex align-center justify-space-between">
          ...
          <div class="d-flex flex-column">
            <v-btn class="mb-2 bg-gray" text @click="openFundWallet">
              Fund Wallet
            </v-btn>
      ...
      <v-dialog v-model="fundWalletDialog" max-width="400px">
        <v-card>
          ...
          <v-card-text>
            <v-text-field label="Amount" v-model="amount" type="number" prepend-inner-icon="mdi-currency-ngn" />
          </v-card-text>
          <v-card-actions>
  ...
  const creditHistory = ref([
    {
      date: "27 March 2025",
      description: "Getting Started Bonus.",
      amount: "1,500.00",
      old_balance: "0.00",
